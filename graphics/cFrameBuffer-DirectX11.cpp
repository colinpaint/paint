...
// private
string cFrameBuffer::getInternalFormat (uint32_t formatNum) { return ""; }
string cFrameBuffer::getTextureParameters (uint32_t id) { return ""; }
string cFrameBuffer::getRenderbufferParameters (uint32_t id) { return ""; }
