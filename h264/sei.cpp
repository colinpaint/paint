...
namespace {
  ...
  //{{{
  void processPictureTiming (uint8_t* payload, int size, cDecoder264* decoder) {
  ...
  //{{{
  void process_spare_pic (uint8_t* payload, int size, cDecoder264* decoder) {
  ...
  //}}}
  //{{{
  void process_subsequence_layer_characteristics_info (uint8_t* payload, int size, cDecoder264* decoder)
  {
  ...
  //}}}
  //{{{
  void processFilmGrain (uint8_t* payload, int size, cDecoder264* decoder) {
  ...
  //}}}
  //{{{
  void process_frame_packing_arrangement_info (uint8_t* payload, int size, cDecoder264* decoder) {
