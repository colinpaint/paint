...
extern uint8_t** new_mem2D (int dim0, int dim1);
extern int getMem2D (uint8_t*** array2D, int dim0, int dim1);
extern int getMem3D (uint8_t**** array3D, int dim0, int dim1, int dim2);
extern int getMem4D (uint8_t***** array4D, int dim0, int dim1, int dim2, int dim3);
...
extern void freeMem2D (uint8_t** array2D);
extern void freeMem3D (uint8_t*** array3D);
extern void freeMem4D (uint8_t**** array4D);
