...
namespace {
  ...
  //{{{
  void img2buf (sPixel** imgX, uint8_t* buf,
  ...
  //}}}
  //{{{
  void clearPicture (cDecoder264* decoder, sPicture* p) {
  ...
  //}}}
  //{{{
  void writeOutPicture (cDecoder264* decoder, sPicture* p) {
  ...
  //}}}
  //{{{
  void flushPendingOut (cDecoder264* decoder) {
  ...
  //}}}
  //{{{
  void writePicture (cDecoder264* decoder, sPicture* p, int realStructure) {
  ...
  //}}}
  //{{{
  void writeUnpairedField (cDecoder264* decoder, cFrameStore* frameStore) {
  ...
  //}}}
  //{{{
  void flushDirectOutput (cDecoder264* decoder) {
...
void directOutput (cDecoder264* decoder, sPicture* picture) {
  ...
  if (decoder->outBuffer->isUsed == 3) {
    ...
    decoder->outBuffer->dpbCombineField (decoder);
