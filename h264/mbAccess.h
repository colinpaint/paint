...
extern void getAffNeighbour (sMacroblock* mb, int xN, int yN, int mbSize[2], sPixelPos* pix);
extern void getNonAffNeighbour (sMacroblock* mb, int xN, int yN, int mbSize[2], sPixelPos* pix);
extern void get4x4Neighbour (sMacroblock* mb, int xN, int yN, int mbSize[2], sPixelPos* pix);
extern void get4x4NeighbourBase (sMacroblock* mb, int blockX, int blockY, int mbSize[2], sPixelPos* pix);
