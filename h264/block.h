...
extern void iMBtrans4x4 (sMacroblock* curMb, eColorPlane pl, int smb);
extern void iMBtrans8x8 (sMacroblock* curMb, eColorPlane pl);

extern void itrans_sp_cr (sMacroblock* curMb, int uv);

extern void Inv_Residual_trans_4x4 (sMacroblock* curMb, eColorPlane pl, int ioff, int joff);
extern void Inv_Residual_trans_8x8 (sMacroblock* curMb, eColorPlane pl, int ioff,int joff);
extern void Inv_Residual_trans_16x16 (sMacroblock* curMb, eColorPlane pl);
extern void Inv_Residual_trans_Chroma (sMacroblock* curMb, int uv);

extern void itrans4x4 (sMacroblock* curMb, eColorPlane pl, int ioff, int joff);
extern void itrans4x4_ls(sMacroblock* curMb, eColorPlane pl, int ioff, int joff);
extern void itrans_sp (sMacroblock* curMb, eColorPlane pl, int ioff, int joff);
extern void itrans_2 (sMacroblock* curMb, eColorPlane pl);
extern void iTransform (sMacroblock* curMb, eColorPlane pl, int smb);
