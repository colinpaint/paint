...
extern void cabac_new_slice (mSlice* currSlice);
...
extern void readIPCM_CABAC (mSlice* currSlice, struct datapartition_dec *dP);

extern int  cabac_startcode_follows (mSlice* currSlice, int eos_bit);

extern int  readSyntaxElement_CABAC (sMacroblock* currMB, SyntaxElement *se, sDataPartition *this_dataPart);

extern int check_next_mb_and_get_field_mode_CABAC_p_slice (mSlice* currSlice, SyntaxElement *se, sDataPartition  *act_dp);
extern int check_next_mb_and_get_field_mode_CABAC_b_slice (mSlice* currSlice, SyntaxElement *se, sDataPartition  *act_dp);
