...
void free_mem2Dmp (sPicMotionParam** array2D)
{
  if (array2D) {
    if (*array2D)
      ...
      error ("free_mem2Dmp: trying to free unused memory");
...
void free_mem3Dmp (sPicMotionParam** *array3D)
{
  if (array3D)
  {
    ...
    error ("free_mem3Dmp: trying to free unused memory");
}
//}}}
...
void free_mem2D_spp (sPicturePtr** array2D)
{
  if (array2D)
  {
    if (*array2D)
      ...
      error ("free_mem2D_spp: trying to free unused memory");
...
void free_mem3D_spp (sPicturePtr** *array3D)
{
  if (array3D)
  {
    ...
    error ("free_mem3D_spp: trying to free unused memory");
}
//}}}
//{{{
void free_mem2Dmv (sMotionVec** array2D)
{
  if (array2D)
  {
    if (*array2D)
      ...
      error ("free_mem2Dmv: trying to free unused memory");
...
void free_mem3Dmv (sMotionVec** *array3D)
{
  if (array3D)
  {
    ...
    error ("free_mem3Dmv: trying to free unused memory");
}
//}}}
//{{{
void free_mem4Dmv (sMotionVec** **array4D)
{
  if (array4D)
  {
    ...
    error ("free_mem4Dmv: trying to free unused memory");
}
//}}}
//{{{
void free_mem5Dmv (sMotionVec** ***array5D)
{
  if (array5D)
  {
    ...
    error ("free_mem5Dmv: trying to free unused memory");
}
//}}}
//{{{
void free_mem6Dmv (sMotionVec** ****array6D)
{
  if (array6D)
  {
    ...
    error ("free_mem6Dmv: trying to free unused memory");
}
//}}}
//{{{
void free_mem7Dmv (sMotionVec** *****array7D)
{
  if (array7D)
  {
    ...
    error ("free_mem7Dmv: trying to free unused memory");
}
//}}}
...
void free_mem1Dpel (sPixel *array1D)
{
  if (array1D)
    ...
    error ("free_mem1Dpel: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem2Dpel (sPixel** array2D)
{
  if (array2D)
  {
    if (*array2D)
     ...
     error ("free_mem2Dpel: trying to free unused memory");
...
void free_mem2Dpel_pad (sPixel** array2D, int iPadY, int iPadX)
{
  if (array2D)
  {
    if (*array2D)
      ...
      error ("free_mem2Dpel_pad: trying to free unused memory");
...
void free_mem3Dpel (sPixel** *array3D)
{
  if (array3D)
  {
    ...
    error ("free_mem3Dpel: trying to free unused memory");
}
//}}}
//{{{
void free_mem3Dpel_pad (sPixel** *array3D, int iDim12, int iPadY, int iPadX)
{
  if (array3D)
  {
    ...
    error ("free_mem3Dpel_pad: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem4Dpel (sPixel** **array4D)
{
  if (array4D)
  {
    ...
    error ("free_mem4Dpel: trying to free unused memory");
}
//}}}
//{{{
void free_mem4Dpel_pad (sPixel ** **array4D, int iFrames, int iPadY, int iPadX)
{
  if (array4D)
  {
    ...
    error ("free_mem4Dpel_pad: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem5Dpel (sPixel** ***array5D)
{
  if (array5D)
  {
    ...
    error ("free_mem5Dpel: trying to free unused memory");
}
//}}}
//{{{
void free_mem5Dpel_pad (sPixel** ***array5D, int iFrames, int iPadY, int iPadX)
{
  if (array5D)
  {
    ...
    error ("free_mem5Dpel_pad: trying to free unused memory");
}
//}}}
...
void free_mem2Dint (int** array2D)
{
  if (array2D)
  {
    if (*array2D)
      ...
      error ("free_mem2Dint: trying to free unused memory");
...
void free_mem2Dint_pad (int** array2D, int iPadY, int iPadX)
{
  if (array2D)
  {
    if (*array2D)
      ...
      error ("free_mem2Dint_pad: trying to free unused memory");
...
void free_mem2Dint64 (int64** array2D)
{
  if (array2D)
  {
    if (*array2D)
      ...
      error ("free_mem2Dint64: trying to free unused memory");
    memFree (array2D);
  }
  else
    error ("free_mem2Dint64: trying to free unused memory");
...
void free_mem3D (byte** *array3D)
{
  if (array3D)
  {
   ...
   memFree (array3D);
    ...
    error ("free_mem3D: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem4D (byte** **array4D)
{
  if (array4D)
  {
   ...
   memFree (array4D);
    ...
    error ("free_mem4D: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem3Dint (int** *array3D)
{
  if (array3D)
  {
   ...
   memFree (array3D);
    ...
    error ("free_mem3Dint: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem3Dint64 (int64** *array3D)
{
  if (array3D)
  {
   ...
   memFree (array3D);
    ...
    error ("free_mem3Dint64: trying to free unused memory");
}
//}}}
//{{{
void free_mem3Ddistblk (distblk** *array3D)
{
  if (array3D)
  {
   ...
   memFree (array3D);
    ...
    error ("free_mem3Ddistblk: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem4Dint (int** **array4D)
{
  if (array4D)
  {
    ...
    error ("free_mem4Dint: trying to free unused memory");
}
//}}}
//{{{
void free_mem4Dint64 (int64** **array4D)
{
  if (array4D)
  {
    ...
    error ("free_mem4Dint64: trying to free unused memory");
}
//}}}
//{{{
void free_mem4Ddistblk (distblk** **array4D)
{
  if (array4D)
  {
    ...
    error ("free_mem4Ddistblk: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem5Dint (int** ***array5D)
{
  if (array5D)
  {
    ...
    error ("free_mem5Dint: trying to free unused memory");
}
//}}}
...
void free_mem2Duint16 (uint16** array2D)
{
  if (array2D)
  {
    if (*array2D)
      memFree (*array2D);
    else error ("free_mem2Duint16: trying to free unused memory");

    memFree (array2D);
  }
  else
    error ("free_mem2Duint16: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem3Duint16 (uint16** *array3D)
{
  if (array3D)
  {
   ...
   memFree (array3D);
    ...
    error ("free_mem3Duint16: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem4Duint16 (uint16** **array4D)
{
  if (array4D)
  {
    ...
    error ("free_mem4Duint16: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem2Dshort (short** array2D)
{
  if (array2D)
  {
    if (*array2D)
      memFree (*array2D);
    else error ("free_mem2Dshort: trying to free unused memory");

    memFree (array2D);
  }
  else
    error ("free_mem2Dshort: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem3Dshort (short** *array3D)
{
  if (array3D)
  {
   ...
   memFree (array3D);
    ...
    error ("free_mem3Dshort: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem4Dshort (short** **array4D)
{
  if (array4D)
  {
    ...
    error ("free_mem4Dshort: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem5Dshort (short** ***array5D)
{
  if (array5D)
  {
    ...
    error ("free_mem5Dshort: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem6Dshort (short** ****array6D)
{
  if (array6D)
  {
    ...
    error ("free_mem6Dshort: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem7Dshort (short** *****array7D)
{
  if (array7D)
  {
    ...
    error ("free_mem7Dshort: trying to free unused memory");
}
//}}}
...
void free_mem2Ddouble (double** array2D)
{
  if (array2D)
  {
    if (*array2D)
      ...
      error ("free_mem2Ddouble: trying to free unused memory");
...
void free_mem1Dodouble (double *array1D, int offset)
{
  if (array1D)
  {
    ...
    error ("free_mem1Dodouble: trying to free unused memory");
}
//}}}
//{{{
/*!
...
void free_mem2Dodouble (double** array2D, int offset)
{
  if (array2D)
  {
    ...
    if (array2D[0])
      memFree (array2D[0]);
    else error ("free_mem2Dodouble: trying to free unused memory");

    memFree (array2D);

  } else
    error ("free_mem2Dodouble: trying to free unused memory");
}
//}}}
//{{{
/*!
    ...
    for (i = 0; i < dim0; i++)
    {
      for (j = -offset; j < dim1 - offset; j++)
      {
        if (array3D[i][j])
          ...
          error ("free_mem3Dodouble: trying to free unused memory");
      }
    }
    array3D[0] -= offset;
    if (array3D[0])
    ...
    for (i = 0; i < dim0; i++)
    {
      for (j = -offset; j < dim1 - offset; j++)
      {
        if (array3D[i][j])
          ...
          error ("free_mem3Doint: trying to free unused memory");
      }
    }
    array3D[0] -= offset;
    if (array3D[0])
...
void free_mem2Doint (int** array2D, int offset)
{
  if (array2D)
  {
    ...
    if (array2D[0])
      ...
      error ("free_mem2Doint: trying to free unused memory");
...
void free_offset_mem2Dshort (short** array2D, int dim1, int offset_y, int offset_x)
{
  if (array2D)
  {
    ...
    if (array2D[0])
      ...
      error ("free_offset_mem2Dshort: trying to free unused memory");
...
void free_mem2Ddistblk (distblk** array2D)
{
  if (array2D)
  {
    if (*array2D)
      ...
      error ("free_mem2Ddistblk: trying to free unused memory");
    free (array2D);
  }
  else
    error ("free_mem2Ddistblk: trying to free unused memory");
