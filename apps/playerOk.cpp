...
namespace {
  ...
  public:
    ...
    bool play() {
      ...
      if (!file) {
        //{{{  error, return
        cLog::log (LOGERROR, fmt::format ("cFilePlayer::play failed to open {}", mFileName));
        return false;
        }
        //}}}
      ...
      if (!mTransportStream) {
        //{{{  error, return
        cLog::log (LOGERROR, "cFilePlayer::play ts create failed");
        return false;
        }
        //}}}
  ...
  public:
    ...
    void addFile (const string& fileName, cPlayerOptions* options) {
      ...
      mFilePlayers.push_back (cFilePlayer (fileName, options));
      mFilePlayers.back().analyse();
      mFilePlayers.back().play();
      }
    //}}}
