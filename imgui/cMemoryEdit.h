...
private:
  ...
  //}}}
  //{{{
  void calcSizes (sSizes& s, size_t mem_size, size_t base_display_addr) {
  ...
  //}}}
  //{{{
  void drawOptionsLine (const sSizes& s, void* mem_data, size_t mem_size, size_t base_display_addr) {
  ...
  //}}}
  //{{{
  void drawPreviewLine (const sSizes& s, void* mem_data_void, size_t mem_size, size_t base_display_addr) {
