...
static bool ImGui_ImplVulkan_CreateDeviceObjects() {
  ...
  //{{{  create descriptorSetAllocateInfo:
  {
  ...
  ImGui_ImplVulkan_CreatePipeline (v->Device, v->Allocator,
                                   v->PipelineCache, bd->RenderPass, v->MSAASamples, &bd->Pipeline, bd->Subpass);
  return true;
  }
//}}}
//{{{
...
//}}}
static void ImGui_ImplVulkan_ShutdownPlatformInterface() { ImGui::DestroyPlatformWindows(); }
