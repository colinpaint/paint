...
// In the meanwhile we implement custom per-platform workarounds here 
// (FIXME-VIEWPORT: Implement same work-around for Linux/OSX!)
  ...
  static LRESULT CALLBACK WndProcNoInputs(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    if (msg == WM_NCHITTEST) {
      ...
      // This will allow the backend to set io.MouseHoveredViewport properly (which is OPTIONAL).
      // The ImGuiViewportFlags_NoInputs flag is set while dragging a viewport,
      // as want to detect the window behind the one we are dragging.
      // If you cannot easily access those viewport flags from your windowing/event code:
      // you may manually synchronize its state e.g. in
